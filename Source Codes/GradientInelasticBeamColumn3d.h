...
#ifndef GradientInelasticBeamColumn3d_H
#define GradientInelasticBeamColumn3d_H
...
class GradientInelasticBeamColumn3d : public Element
{
public:
	// Constructors
...
#endif // GradientInelasticBeamColumn3d_H
