...
For more information about the GI element formulation and its command description, please refer to "GI Element in OpenSees.pdf" and the references at the end of this page.
